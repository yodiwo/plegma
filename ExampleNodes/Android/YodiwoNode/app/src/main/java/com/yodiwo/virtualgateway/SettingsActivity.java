...
public class SettingsActivity extends PreferenceActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_mqtt_port_key)));
        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_device_comm_chan_key)));
    }
