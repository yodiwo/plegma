...
/**
 * Created by ApiGenerator Tool (Java) on 3/8/2015 10:26:21 &#956;&#956;.
 */

/**
 * Node Things Message Can be asyncronous (self-triggered) or in response to a Yodiwo.API.Plegma.ThingsReq request
...
public class ThingsMsg extends ApiMsg {
    ...
    public ThingsMsg(eThingsOperation Operation, Boolean Status, Thing[] Data, int Version, int SeqNo, int ResponseToSeqNo) {
