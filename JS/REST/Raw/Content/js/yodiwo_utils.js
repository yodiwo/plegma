...
function isNullOrWhitespace(str) {
    ...
    if (typeof str === 'string' || str instanceof String) {
        ...
        // it's something else
        console.log("isNullOrWhitespace() input passed in:%O is not a string!", str);
        return false;
    }
}
...
function hideControlSidebar() {
    ...
    if ($(".control-sidebar").hasClass("control-sidebar-open")) {
        ...
        // show showControlSidebarButton
        $('#showControlSidebarButton').show();
        // hide hideControlSidebarButton
        // $('#hideControlSidebarButton').hide();
    }
}
...
function showControlSidebar() {
    ...
    if (!$(".control-sidebar").hasClass("control-sidebar-open")) {
        ...
        {
            // hide showControlSidebarButton
            $('#showControlSidebarButton').hide();
            // show hideControlSidebarButton
            $('#hideControlSidebarButton').show();
        }
    }
}
