...
public class SettingsProvider {
    ...
    public Boolean getServiceRotationEnabled() {
        return prefs.getBoolean(context.getString(R.string.pref_service_accelerometer_key),
                Boolean.parseBoolean(context.getString(R.string.pref_service_accelerometer_default)));
    }
    ...
    public Boolean getServiceGyroscopeEnabled() {
        return prefs.getBoolean(context.getString(R.string.pref_service_gyroscope_key),
                Boolean.parseBoolean(context.getString(R.string.pref_service_gyroscope_default)));
    }
