...
{
    /* GRABBED FROM https://github.com/samuelneff/MimeTypeMap
     * 
     * @hash: 8ae7e3870f7991006bdb535a1b40cd9dd9b5b4a7
     * 
     * Licensed under the MIT license: https://github.com/samuelneff/MimeTypeMap/blob/master/LICENSE
     */
    ...
    public static class MimeTypeMap
    {
        ...
        public static string GetExtension(string mimeType)
        {
            ...
            {
                DebugEx.TraceError("Requested mime type is not valid: " + mimeType);
                return null;
            }
            ...
            DebugEx.TraceWarning("Requested mime type is not registered: " + mimeType);
            return null;
        }
    }
}