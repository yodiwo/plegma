...
{
    [Serializable]
    public class ListTS<T> : IList<T>, IReadOnlyList<T>, IList
    {
        #region Variables
        //------------------------------------------------------------------------------------------------------------------------
        ...
        //------------------------------------------------------------------------------------------------------------------------
        void IList.Insert(int index, object value) { if (value is T) Insert(index, (T)value); }
        //------------------------------------------------------------------------------------------------------------------------
        void IList.Remove(object value) { if (value is T) Remove((T)value); }
        //------------------------------------------------------------------------------------------------------------------------
