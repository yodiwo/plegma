...
namespace Yodiwo
{
    public static partial class Extensions
    {
...
#else
            return source.StartsWith(toCheck, CaseSensitive);
#endif
        }
        //----------------------------------------------------------------------------------------------------------------------------------------------
...
#elif UNIVERSAL
            return source.EndsWith(toCheck, CaseSensitive);
#endif
        }
        //----------------------------------------------------------------------------------------------------------------------------------------------
        ...
        /// <param name="val"></param>
        /// <returns></returns>
        public static string ToStringEx<T>(this T[] val, int length)
        {
            string s = "{ ";
            foreach (var m in val.EnumerateWithLimit(length))
                s += m + " ";
            return s + "}";
        }
