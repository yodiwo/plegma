...
//    private Context context = getApplicationContext();
    ...
    public void onMessageReceived(String from, Bundle data) {
        ...
        Helpers.log(Log.DEBUG, TAG, "From: " + from);
        Helpers.log(Log.DEBUG, TAG, "GCM received msg: " + message);
        ...
        if (from.startsWith("/topics/")) {
            ...
            if (message != null) {
                ...
                Helpers.log(Log.INFO, TAG, "type: " + msgFlags + " SyncID: " + msgSyncId + " payload:" + msgPayload);
    ...
    public void onDeletedMessages (){
        ...
        Helpers.log(Log.DEBUG, TAG, "Deleted messages on server");
    }
    ...
    public void onMessageSent (String syncId){
         ...
         */
        Helpers.log(Log.DEBUG, TAG, "Successfully sent upstream message. syncId= " + syncId);
    }
    ...
    public void onSendError (String syncId, String error){
         ...
         */
        Helpers.log(Log.ERROR, TAG, "Error: " + error + " with syncId" + syncId);
    }
}
