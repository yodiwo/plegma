...
public class GcmServerAPI extends aServerAPI {
    ...
    protected static final String SENDER_ID = "1068342325007";
    ...
    public GcmServerAPI(Context context) {
        ...
        if (SENDER_ID.replace(" ", "").length() == 0) {
            Helpers.log(Log.DEBUG, TAG, "GCM server API cannot be started: Empty Sender ID.");
            return;
        }

        Helpers.log(Log.DEBUG, TAG, "Starting GCM server API.");
    ...
    public void Connect() {
        ...
        try {
            ...
            Helpers.log(Log.DEBUG, TAG, "GCM new status: " + sentTokenToServer);
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (apiAvailability.isUserResolvableError(resultCode)) {
                ...
                Helpers.log(Log.INFO, TAG, "The device does not support GCM protocol.");
            }
            return false;
        }
        return true;
            ...
            new AsyncTask<Void, Void, String>() {
                ...
                protected String doInBackground(Void... params) {
                    try {
                        ...
                        Helpers.log(Log.DEBUG, TAG, "Successfully sent upstream message");
                        return "";
