...
/**
 * Service for managing connection and data communication with a GATT (GENERIC ATTRIBUTE PROFILE)
...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_WRITE_RESPONSE_OK = "ACTION_WRITE_RESPONSE_OK";
    public final static String ACTION_WRITE_RESPONSE_ERROR = "ACTION_WRITE_RESPONSE_ERROR";
    public final static String EXTRA_DATA = "EXTRA_DATA";
    public final static String EXTRA_CHAR = "EXTRA_CHAR";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                Log.d(TAG, "onServicesDiscovered received, status: " + status + ", device:" + gatt.getDevice().getName());
                DeviceScanActivity.storeGattData(getSupportedGattServices());
    ...
    public boolean writeNoResponseCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        Log.d(TAG, "Ready to write gatt characteristic");
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        Log.d(TAG, "Ready to set gatt characteristic notification");
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) {
            ...
            intent.putExtra(EXTRA_CHAR, characteristic.getUuid().toString());
        }
